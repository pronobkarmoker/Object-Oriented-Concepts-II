package Generics.src;// Fig. 18.15: WildcardTest.java
...
public class WildcardTest {
    public static void main(String args[]) {
        ...
        // display the total of the elements
        ...
        // both Integers and Doubles, then display the total of the elements
    ...
    // calculate the total of ArrayList elements
